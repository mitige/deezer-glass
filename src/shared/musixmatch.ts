...
export function parseMusixmatchMacro(json: unknown): { synced: LyricLine[] | null; plain: string | null; matchedTitle: string | null; matchedArtist: string | null; matchedLength: number | null } {
  ...
  const trk = macro?.['matcher.track.get'] as { message?: { body?: { track?: { track_name?: string; artist_name?: string; track_length?: number } } } } | undefined
  ...
  return {
    ...
    matchedLength: typeof mt?.track_length === 'number' ? mt.track_length : null,
  }
}
